      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {!hasSearched && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 mt-2 max-w-md mx-auto">
              Enter your details above and we will search across Adzuna, Arbeitnow, Himalayas, The Muse, and RemoteOK to find the best matches for you.
            </p>
            <div className="flex justify-center gap-3 mt-6 flex-wrap">
              {['Adzuna', 'Arbeitnow', 'Himalayas', 'The Muse', 'RemoteOK'].map((platform) => (
                <span
                  key={platform}
